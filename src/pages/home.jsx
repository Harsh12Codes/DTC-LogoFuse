...
const Home = () => {
    ...
    return (
        <div className="w-full  h-screen flex justify-between items-center bg-white font-inter p-4 flex-1 max-1000:flex-col max-1000:gap-8">
            <div className="flex justify-center items-center">
                <Hero />
            </div>
            <div className="w-[500px] h-full rounded-3xl p-3 flex items-center justify-center gap-8  max-md:gap-4 flex-col max-1000:max-w-[500px] max-1000:w-full">
                <div className="w-full flex flex-col h-[350px] flex-1">
                    <FileUpload
